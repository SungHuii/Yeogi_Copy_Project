...
import BtnSocialLogin from "../components/Common/BtnSocialLogin";

const LoginPage = () => {

    const btnSocial = [
        {title: "카카오", socialClass: "kakao-login"},
        {title: "네이버", socialClass: "naver-login"},
        {title: "구글", socialClass: "google-login"},
    ]
        ...
        <div className="App">
            ...
            <div className="login">
                ...
                <div className="login__btn-group">
                    {btnSocial.map((item) => (
                        <BtnSocialLogin key={item.title} title={item.title} className={item.socialClass} />
                    ))}
                </div>
            </div>
        </div>
